...
function showSales(period) {
    ...
    if (period === 'today') {
        ...
        salesInfo = 'Total Sales: ₱' + <?php echo $total_sales_today; ?>.toFixed(2);
    } else if (period === 'week') {
        salesHeading = `Sales for the Week: ${firstDayFormatted} to ${lastDayFormatted}`;
        salesInfo = 'Total Sales: ₱' + <?php echo $total_sales_week; ?>.toFixed(2);
    } else if (period === 'month') {
        salesHeading = 'Sales for ' + currentMonth + ' ' + currentYear;
        salesInfo = 'Total Sales: ₱' + <?php echo $total_sales_month; ?>.toFixed(2);
    } else if (period === 'year') {
        salesHeading = 'Sales for Year ' + currentYear;
        salesInfo = 'Total Sales: ₱' + <?php echo $total_sales_year; ?>.toFixed(2);
    }
...
// Show today's sales by default on page load
showSales('today');
</script>
